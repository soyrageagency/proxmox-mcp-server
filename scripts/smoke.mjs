...
ok("full mode exposes 19 tools", tools.length === 19, `got ${tools.length}`);
...
ok("read-only hides lifecycle/snapshot writes", !roTools.includes("start_guest") && !roTools.includes("create_snapshot"));
ok("read-only keeps insight", roTools.includes("list_guests") && roTools.includes("list_snapshots"));
