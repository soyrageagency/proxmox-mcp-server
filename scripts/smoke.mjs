...
ok("full mode exposes 39 tools", tools.length === 39, `got ${tools.length}`);
ok("has diagnostics", tools.includes("cluster_health") && tools.includes("find_idle_guests") && tools.includes("find_orphaned_disks"));
